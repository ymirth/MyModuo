...
public:
    ...
    std::string toDefaultLogString() const
    {
        char buf[32] = {0};
        auto seconds = std::chrono::duration_cast<std::chrono::seconds>(m_time_point.time_since_epoch());
        auto microseconds = std::chrono::duration_cast<std::chrono::microseconds>(m_time_point.time_since_epoch());
    ...
    {
        return std::chrono::duration_cast<std::chrono::seconds>(m_time_point.time_since_epoch()).count();
    }
    int64_t microsecondsSinceEpoch() const
    {
        return std::chrono::duration_cast<std::chrono::microseconds>(m_time_point.time_since_epoch()).count();
    }
